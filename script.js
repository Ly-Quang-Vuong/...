...
const birthdayDate = new Date('2026-09-25T00:00:00').getTime();
...
const reasons = [
  ...
  'Your Lship feels like a blessing.',
...
const letterText = `ummm... Hôm nay là sinh nhật của em, anh viết vài dòng này không có ý định làm xáo trộn cuộc sống hiện tại của em, chỉ đơn giản là một lời chúc chân thành từ anh. Chúc em tuổi mới thật nhiều niềm vui, may mắn, luôn bình an, xinh đẹp và đạt được những điều em đang ấp úng thực hiện. Mong rằng em luôn luôn mỉm cười và tìm thấy hạnh phúc trọn vẹn với những lựa chọn của mình. Sinh nhật vui vẻ em nha hẹ hẹ 🫶 `;
